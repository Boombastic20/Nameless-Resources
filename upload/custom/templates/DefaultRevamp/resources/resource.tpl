				...
				<div class="twelve wide column">
					...
					{elseif isset($PURCHASE_FOR_PRICE)}
						...
						{else}disabled
							...
							{* Discount *}
							{if isset($DISCOUNT)}
								<button class="ui green button active">-{$DISCOUNT}% off</button>
							{/if}
							{* End Discount *}
						...
						<span class="pull-right">
							{if isset($CAN_EDIT)}
								...
								<div class="ui small modal" id="modal-icon-upload">
									...
									<div class="content">
										<form action="{$CHANGE_ICON_ACTION}" method="post" enctype="multipart/form-data" class="ui form"
					...
					<div class="form-group">
						...
						{else}
							...
							<span class="pull-right"><i data-toggle="popover" data-placement="top" data-html="true"
									data-content="{$MARKDOWN_HELP}" class="fa fa-question-circle text-info" aria-hidden="true"></i></span>
						{/if}
					</div>
					<br />
					<div class="form-group">
